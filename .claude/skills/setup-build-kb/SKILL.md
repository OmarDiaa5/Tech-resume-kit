...
- "experience" / "bundles" / "skills" / "portfolio" / "reframing" / "significance" → run only that component
...
- If fewer than 2 extractions: warn "Only [N] extraction(s) found. KB quality improves with more sources. Continue anyway?"

Progress: "Found [N] extractions across [M] categories. Config has [K] role types defined."
...
1. Group extractions by the category they belong to (based on source type, dates, institution, or user clarification)
2. Ask the user to confirm grouping if ambiguous: "I've grouped these under [Category]. Correct?"
...
Present the experience file(s) — show achievement count per category, total bullet variants.
...
- Projects: [N] ([breakdown by status])
- GitHub repos: [N]
- Top methods: [ranked list]

## Categories

### [Category 1: e.g., Machine Learning & AI]
| Skill | Proficiency | Evidence | Resume Weight |
|-------|-----------|----------|---------------|
| [skill] | [expert/proficient/familiar] | [source IDs] | [HIGH/MED/LOW] |

### [Category 2: e.g., Programming & Software]
[same table format]

### [Category 3: e.g., Web Development]
[same table format]
...
**Proficiency levels:**
- **Expert:** Used across 3+ projects with custom implementations; comfortable teaching
- **Proficient:** Used in 2+ projects with practical results
- **Familiar:** Used in 1 project or coursework

Progress: "Built taxonomy — [N] skills across [M] categories"

---

## Phase 3: Build Portfolio Metadata

**Goal:** Structured portfolio data for resume/CV generation.

**Build** `resume_builder/support/portfolio_metadata.md`:

```markdown
# Portfolio Metadata

## Summary
- Total projects: [N] (GitHub-hosted: [M])
- Competitions: [N] (Awards: [list])
- Certifications: [N] (In-progress: [M])
- Internships: [N]

## Projects
| # | Project | Repo | Tech Stack | Key Metric | Status |
|---|---------|------|-----------|------------|--------|
| 1 | [project name] | [GitHub URL or N/A] | [tech stack] | [key metric] | [status] |

## Competition Results
| # | Competition | Placement | Date | Key Achievement |
|---|------------|-----------|------|----------------|
| 1 | [competition name] | [placement] | [date] | [achievement] |

## Certifications & Training
| # | Certification | Provider | Score/Grade | Date | Status |
|---|--------------|----------|-------------|------|--------|
| 1 | [cert name] | [provider] | [score] | [date] | [status] |
```

Progress: "Portfolio metadata — [N] projects, [M] competitions, [K] certifications"
...
**Overclaiming warning:** [if applicable — e.g., "Do not claim sole credit for team results"]
**First-pass checklist:** [ ] Verb matches user role [ ] Numbers from source [ ] Status matches provenance
...
**Institution type:** [Industry / Startup / Academic]
...
**The problem:** [What challenge does this address? Industry/technical context]
**Competing approaches:** [What else exists? What are the limitations?]
**Why this matters:** [Market size, industry demand, growth trends]
...
| Portfolio metadata | `support/portfolio_metadata.md` | [DONE/MISSING] | [N entries] |
