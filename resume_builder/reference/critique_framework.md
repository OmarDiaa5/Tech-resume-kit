...
7. **Competitive landscape intuition:** Who else is applying for this role?
   ...
   - What does THIS candidate offer that the obvious fit doesn't? (e.g., production-scale projects, cross-domain breadth, open-source contributions)
   - What does the obvious fit offer that this candidate doesn't? (e.g., domain-specific experience, direct tool experience)
...
**What they do:** Read every bullet carefully. Check project portfolio. Assess truthfulness. Look for inconsistencies.
...
- **Verb discipline:** Contributing-role bullets use hedged verbs? Full-ownership verbs only where justified?
- **Portfolio coherence:** Do project descriptions match the resume's domain framing? Do project names or repo descriptions create cognitive dissonance with the reframed bullets?
...
| 5 | Projects & Portfolio | 10% | Project depth, repo quality, competition results, certification relevance, demo quality |
...
| 8 | Credibility Signals | 10% | Project impact, metrics (deployments, users, stars, awards), platform adoption, leadership evidence |
...
If a cover letter was generated in the same session, run all checks below. Detect institution type first: Industry / Startup.
...
- [ ] Names a specific company/product/project from the target institution
...
- [ ] Names specific product/technology/project from the target company
...
- [ ] Impact framed in business terms? (revenue, users, performance, cost savings)
- [ ] Jargon minimized for HR/recruiter first reader?

**Startup:**
- [ ] Startup awareness in P1? (funding stage, product-market fit, growth trajectory)
- [ ] Builder/ownership signals present? ("built from scratch," "wore multiple hats," "shipped to production")
- [ ] Tech stack alignment addressed? (specific technologies matching their stack)
...
- Industry: keywords matter (~60% of large employers use ATS/AI on CLs). Startups: less critical but still relevant.
...
- [ ] **Word count:** Industry 250-300, Startup 200-250
- [ ] **Tone match:** Industry = results-driven, Startup = builder/product-focused
...
- [ ] **Page budget:** Resume+CL = 2pp total.
...
| Projects & Portfolio | X/10 | 10% | X.XX | |
...
- [ ] Project entries match portfolio_metadata.md (names, descriptions, technologies)
